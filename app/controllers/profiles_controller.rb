class ProfilesController < ApplicationController
  ...
  def activate
    ...
    Profile.set({:id => params[:id]}, {:active => true})
    redirect_to :back, notice: "Profile activated!"
  end
  
  def duplicate
    profile = Profile.find_by_id params[:id]
    new_profile = Profile.create profile.attributes.clone.merge(:name => "#{profile.name}-NEW", :id => nil, :active => false)
    redirect_to :back, notice: "New profile created!"
  end
end
